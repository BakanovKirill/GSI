    ...
    google.maps.event.addListener(kml_map,'click', function(event) {
          ...
          var llMid = event.latLng;
               ...
               var xmlpolyhttp = new XMLHttpRequest();
                ...
                console.log("853 Getting polygon info for "+fileName+", kmlKileName="+kmlFileName);
                xmlpolyhttp.open("GET", "TifPolyVal.php?q=" + fileName + "&r=0&s=0&t=" + kmlFileName, true);
                xmlpolyhttp.send();
         });
  ...
  if (AllowDrawing==1)
  {
    ...
    google.maps.event.addListener(drawingManager, 'rectanglecomplete', function(rectangle) {
        ...
        //alert("Rectangle drawn: "+llSW.lat()+","+llSW.lng()+" to "+llNE.lat()+","+llNE.lng());
                ...
                window.alert("1031 Getting polygon info for "+fileName);
                xmlpolyhttp.open("GET", "TifPolyVal.php?q=" + fileName + "&r=" + polylat + "&s=" + polylon, true);
                xmlpolyhttp.send();
    });
    ...
    google.maps.event.addListener(drawingManager, 'polygoncomplete', function(polygon) {
        ...
        //alert("Polygon drawn: "+llSW.lat()+","+llSW.lng()+" to "+llNE.lat()+","+llNE.lng());
                ...
                console.log("1097 Getting polygon info for "+fileName);
                xmlpolyhttp.open("GET", "TifPolyVal.php?q=" + fileName + "&r=" + polylat + "&s=" + polylon, true);
                xmlpolyhttp.send();
    });
