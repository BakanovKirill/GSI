...
urlpatterns = [
    ...
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/qrf/add/$',
        'cards.views_card_run_csid.new_runid_csid_qrf', name='new_run_csid_qrf'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/rfscore/add/$',
        'cards.views_card_run_csid.new_runid_csid_rfscore', name='new_run_csid_rfscore'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/remap/add/$',
        'cards.views_card_run_csid.new_runid_csid_remap', name='new_run_csid_remap'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/year_filter/add/$',
        'cards.views_card_run_csid.new_runid_csid_year_filter', name='new_run_csid_year_filter'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/collate/add/$',
        'cards.views_card_run_csid.new_runid_csid_collate', name='new_run_csid_collate'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/preproc/add/$',
        'cards.views_card_run_csid.new_runid_csid_preproc', name='new_run_csid_preproc'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/mergecsv/add/$',
        'cards.views_card_run_csid.new_runid_csid_mergecsv', name='new_run_csid_mergecsv'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/rftrain/add/$',
        'cards.views_card_run_csid.new_runid_csid_rftrain', name='new_run_csid_rftrain'),

    # new run card-sequenceID cards edit
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/qrf/(?P<qrf_id>\d+)/$',
        'cards.views_card_run_csid.new_runid_csid_qrf_edit', name='new_run_csid_qrf_edit'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/rfscore/(?P<rfscore_id>\d+)/$',
        'cards.views_card_run_csid.new_runid_csid_rfscore_edit', name='new_run_csid_rfscore_edit'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/remap/(?P<remap_id>\d+)/$',
        'cards.views_card_run_csid.new_runid_csid_remap_edit', name='new_run_csid_remap_edit'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/year_filter/(?P<yf_id>\d+)/$',
        'cards.views_card_run_csid.new_runid_csid_year_filter_edit', name='new_run_csid_year_filter_edit'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/collate/(?P<collate_id>\d+)/$',
        'cards.views_card_run_csid.new_runid_csid_collate_edit', name='new_run_csid_collate_edit'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/preproc/(?P<preproc_id>\d+)/$',
        'cards.views_card_run_csid.new_runid_csid_preproc_edit', name='new_run_csid_preproc_edit'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/mergecsv/(?P<mcsv_id>\d+)/$',
        'cards.views_card_run_csid.new_runid_csid_mergecsv_edit', name='new_run_csid_mergecsv_edit'),
    url(r'^run/card-sequence/(?P<cs_id>\d+)/processing-card/rftrain/(?P<rftrain_id>\d+)/$',
        'cards.views_card_run_csid.new_runid_csid_rftrain_edit', name='new_run_csid_rftrain_edit'),
