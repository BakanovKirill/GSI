...
class DataSetAdmin(admin.ModelAdmin):
    list_display = ('name', 'description', 'results_directory', 'shelf_data',
                    'get_attribute_name', 'get_root_filename', 'name_ts', 'is_ts', 'is_default')
...
class LogAdmin(admin.ModelAdmin):
    list_display = ('user', 'at', 'mode', 'dataset', 'action', 'shapefile', 'ip', 'os_user', 'request_user', 'message', 'status_message')
    search_fields = ['user', 'at', 'mode', 'dataset', 'action', 'shapefile', 'ip', 'os_user', 'request_user', 'status_message']
    list_filter = ('user', 'mode', 'dataset', 'action', 'ip', 'os_user', 'request_user')
