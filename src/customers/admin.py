...
class LogAdmin(admin.ModelAdmin):
    list_display = ('user', 'at', 'mode', 'dataset', 'action', 'customer_polygons', 'message', 'status_message')
    search_fields = ['user', 'at', 'mode', 'dataset', 'action', 'customer_polygons', 'status_message']
